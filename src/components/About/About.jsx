      ...
      <div className="container about-inner">
        ...
        <div className="about-content">
          ...
          <p className="about-intro">
            ...
            of my favorites — struggle simply because they never had clear financial visibility.
            Owners and staff were putting in long hours, yet still couldn’t see where their money
            was going. That reality is what pushed me to create Wok Profit.
          </p>

          <p className="about-intro">
            Wok Profit exists to fix that — giving restaurant owners simple, practical financial
            clarity they can actually use.
          </p>

          <div className="about-proof-box highlight-goal">
            <p>
              <strong>My goal is simple:</strong> make profit clear — and help restaurant owners
